    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <>
            <p className={'block font-bold mb-2'}>Boards User</p>
            <CardBox
            ...
            >
              <div className='overflow-x-auto'>
                <table>
                  ...
                  <tbody>
                    {users.boards_user &&
                      Array.isArray(users.boards_user) &&
                      users.boards_user.map((item: any) => (
                        <tr
                          key={item.id}
                          onClick={() =>
                            router.push(`/boards/boards-view/?id=${item.id}`)
                          }
                        ></tr>
                      ))}
                  </tbody>
